...
@Repository
interface TransportRepository : CrudRepository<Transport, UUID>, PagingAndSortingRepository<Transport, UUID> {
    @Modifying
    @Query("delete from carsharing.transport where id = :id")
